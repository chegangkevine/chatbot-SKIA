...
async function createSubscription(subscriptionData) {
  try {
    ...
    return { success: true, message: 'Bundle successfully created' };
  } catch (error) {
...
async function updateSubscription(subscriptionId, updatedData) {
  try {
    ...
    if (!updatedSubscription) {
      return { success: false, message: 'Bundle not founde' };
    }
...
async function hasActiveSubscription(phoneNumber) {
  ...
  async function addSubscriptionToUser(phoneNumber, subscriptionName, subscriptionDate, expirationDate) {
    try {
      ...
      return { success: true, message: 'Bundle added successfully', subscription: addedSubscription };
    } catch (error) {
      return { success: false, error: error.message };
    }
  }
